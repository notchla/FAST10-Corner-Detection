...
#if PEELING_ENABLED
    uint64_t mask_left_32 = (1 << 29) - 1;
    uint64_t mask_left = mask_left_32 | (mask_left_32 << 32);

    uint64_t mask_right_32 = (1 << (width - 3 - xend)) - 1;
    uint64_t mask_right = mask_left_32 | (mask_left_32 << 32);
#endif

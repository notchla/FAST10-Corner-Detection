...
void fast10._score(const SubImage<byte>& i, const vector<ImageRef>& corners, int b, vector<int>& scores)
{
...
void fast10._detect(const SubImage<byte>& i, vector<ImageRef>& corners, int b)
{
	corners.clear();

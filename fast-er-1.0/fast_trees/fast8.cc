...
void fast8._score(const SubImage<byte>& i, const vector<ImageRef>& corners, int b, vector<int>& scores)
{
...
void fast8._detect(const SubImage<byte>& i, vector<ImageRef>& corners, int b)
{
	corners.clear();
